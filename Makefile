...
GOBUILD=CGO_ENABLED=0 go build -trimpath -ldflags '-X "github.com/ClashCore/clash/constant.Version=$(VERSION)" \
		-X "github.com/ClashCore/clash/constant.BuildTime=$(BUILDTIME)" \
		-w -s -buildid='
